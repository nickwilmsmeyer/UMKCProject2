...
public:
	// Constructor
	BinarySearchTree() : BinaryTree<Item_Type>() {}
...
template<typename Item_Type>
const Item_Type* BinarySearchTree<Item_Type>::min() const {
	return min(this->root);

}

template<typename Item_Type>
const Item_Type* BinarySearchTree<Item_Type>::min(BTNode<Item_Type>* local_root) const {
	if (local_root == NULL)
		return NULL;
...
template<typename Item_Type>
const Item_Type* BinarySearchTree<Item_Type>::max() const {
	return max(this->root);

}

template<typename Item_Type>
const Item_Type* BinarySearchTree<Item_Type>::max(BTNode<Item_Type>* local_root) const {
	if (local_root == NULL)
		return NULL;
...
template<typename Item_Type>
const Item_Type* BinarySearchTree<Item_Type>::find(
	const Item_Type& item) const {
	return find(this->root, item);
}

template<typename Item_Type>
const Item_Type* BinarySearchTree<Item_Type>::find(BTNode<Item_Type>* local_root,
	const Item_Type& target) const {
...
template<typename Item_Type>
bool BinarySearchTree<Item_Type>::insert(const Item_Type& item, const Item_Type& letter) {

	return insert(this->root, item, letter);
}

template<typename Item_Type>
bool BinarySearchTree<Item_Type>::insert(BTNode<Item_Type>*& local_root, const Item_Type& item, const Item_Type& letter) {
...
template<typename Item_Type>
bool BinarySearchTree<Item_Type>::erase(const Item_Type& item) {
	return erase(this->root, item);
}

template<typename Item_Type>
bool BinarySearchTree<Item_Type>::erase(BTNode<Item_Type>*& local_root, const Item_Type& item) {
	if (local_root == NULL) {
		return false;
	}
	else {
...
template<typename Item_Type>
void BinarySearchTree<Item_Type>::replace_parent(BTNode<Item_Type>*& old_root, BTNode<Item_Type>*& local_root) {
	if (local_root->right != NULL) {
